...
namespace Eplan.EplAddin.ApiSampleAddin.Actions
{
    ...
    /// </summary>
    public class ActionApiExtContextMenu : IEplAction
    {
        /// <summary>
        ...
        {
            MessageDisplayHelper.Show("ActionApiContextMenu was called", "ActionApiContextMenu");
        ...
        public void GetActionProperties(ref ActionProperties actionProperties)
        {
            ...
            // firstParam.set("Param1", "1. Parameter for ActionContextMenu"); 
            // actionProperties.addParameter(firstParam);

            // Description 2nd parameter
            // ActionParameterProperties firstParam= new ActionParameterProperties();
            // firstParam.set("Param2", "2. Parameter for ActionContextMenu"); 
            // actionProperties.addParameter(firstParam);
        }
    }
}
